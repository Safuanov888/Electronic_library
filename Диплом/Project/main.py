...
def main():
    ...
    # Текст
    path = "D://ПРОГА/Проектики/Github/Electronic_library/Диплом/Данные/Тестовые/Литература. SQL/Моргунов Е. PostgreSQL. Основы языка SQL (2018).pdf"
    text = process_info(path)
